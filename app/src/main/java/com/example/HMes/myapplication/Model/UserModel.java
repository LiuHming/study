package com.example.HMes.myapplication.Model;

import android.text.TextUtils;

import com.blankj.utilcode.util.LogUtils;
import com.blankj.utilcode.util.ToastUtils;
import com.example.HMes.myapplication.Model.i.QueryUserListener;
import com.example.HMes.myapplication.Model.i.UpdateCacheListener;
import com.example.HMes.myapplication.R;
import com.example.HMes.myapplication.bean.Friend;
...
public class UserModel extends BaseModel{
    ...
    public void register(String username, String password, String pwdagain, final LogInListener listener) {
        ...
        if (TextUtils.isEmpty(password) && password.length() < 5 && password.length() > 20) {
            listener.done(null, new BmobException(CODE_NULL, "请填写密码(6-20位)"));
            return;
        }
        ...
        user.setAge(0);
        user.setSex(true);
        user.setDesc(String.valueOf(R.string.df_js));
    ...
    public void login(String username, String password ,final LogInListener listener) {
        ...
        if (TextUtils.isEmpty(password)) {
            listener.done(null, new BmobException(CODE_NULL, "密码需在6-20位之间"));
            return;
        }
        final MyUser user = new MyUser();
        user.setUsername(username);
