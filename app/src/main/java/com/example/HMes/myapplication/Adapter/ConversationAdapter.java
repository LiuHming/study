package com.example.HMes.myapplication.Adapter;

import android.content.Context;
import android.view.View;

import com.example.HMes.myapplication.R;
import com.example.HMes.myapplication.Utils.TimeUtil;
...
public class ConversationAdapter extends BaseRecyclerAdapter<Conversation> {
    ...
    public void bindView(BaseRecyclerHolder holder, Conversation conversation, int position) {
        ...
        if(obj instanceof String){
            ...
            holder.setImageView(avatar, R.drawable.head_pic, R.id.iv_recent_avatar);
        }else{
